...
// private key generated in slot
// public key generated 
// This is one needed for ECDH
...
// M.Scott 12/7/2021
// private key is in slot
// Input other party's 64 byte public key  
// Do ECDH and calculate 32 byte shared key
int ECCX08Class::generateSharedKey(int slot, byte publicKey[], byte sharedKey[])
{
...
// currently stored private key used to regenerate public key
// useful if public key not stored anywhere
...
//    Serial.println("Into writeSHA256");
  ...
  if (!sendCommand(0x47, 0x07, length, context, length)) {
    return 0;
  }
