...
# This may impacts the signature attached to this certificate, for example changing it from ecdsa_with_sha256 to ecdsa_with_sha384
...
hash= "\"-"+hash+"\""
subject="\"/CN=TiigerTLS client intermediate CA\""
