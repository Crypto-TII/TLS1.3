...
if method=="NIST256" :
    ...
    subprocess.call("openssl x509 -req -set_serial 01 -days 198 -in client.csr "+hash+" -CA intermediate/inter.crt -CAkey intermediate/inter.key -out client.crt",shell=True)
...
if method=="RSA1024" :
    ...
    subprocess.call("openssl x509 -req -in client.csr "+hash+"  -CA intermediate/inter.crt -CAkey intermediate/inter.key -set_serial 01 -days 198 -out client.crt",shell=True)
...
if method=="ED25519" :
    ...
    subprocess.call("openssl x509 -req -set_serial 01 -days 198 -in client.csr -CA intermediate/inter.crt -CAkey intermediate/inter.key -out client.crt",shell=True)
