...
extern void sendBinder(Socket &client,octet *B,octet *BND,octet *IO);
...
extern void sendClientMessage(Socket &client,int rectype,int version,crypto *send,octet *CM,octet *EXT,octet *IO);
