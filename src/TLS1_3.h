...
#define TLS_MAX_IO_SIZE 8192 //6144 //4096 //8192// 6144 //16384? We will want to reduce this as much as possible! But must be large enough to take full certificate chain
