...
static char rootkey[SK_SIZE_1];
static octad ROOTKEY={SK_SIZE_1,sizeof(rootkey),(char *)rootkey};
static char rootkey2[SK_SIZE_2];
static octad ROOTKEY2={SK_SIZE_2,sizeof(rootkey2),(char *)rootkey2};
#else
...
static octad ROOTKEY2={0,0,NULL};
#endif
...
#if SIGTYPE==ECC256SHA384_MLDSA44_SIG
    OCT_kill(&ROOTKEY); OCT_kill(&ROOTKEY2);
    OCT_append_bytes(&ROOTKEY,RAWKEY.val,SK_SIZE_1);
    OCT_append_bytes(&ROOTKEY2,&RAWKEY.val[SK_SIZE_1],SK_SIZE_2);
#else
    OCT_copy(&ROOTKEY,&RAWKEY);
#endif
...
#if SIGTYPE==ECC256SHA384_MLDSA44_SIG
    SAL_tlsSignature(SIG_TYPE_1,&ROOTKEY,&CERT,&SIGNATURE);
    SAL_tlsSignature(SIG_TYPE_2,&ROOTKEY2,&CERT,&SIGNATURE2);
#else
