...
static void add_extension_an(octad *EXTENSIONS,char *alt_name)
{
    ...
    setolen(OID,X509_AN.len,&AN); OCT_append_octad(&AN,&X509_AN);
    setolen(DNS,strlen(alt_name),&NAME); OCT_append_bytes(&NAME,alt_name,strlen(alt_name));
    wrap(SEQ,&NAME);
    wrap(OCT,&NAME);
